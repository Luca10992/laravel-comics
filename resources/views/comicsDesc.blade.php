    ...
    <div class="desc-box">
        ...
        <div class="price-box d-flex">
            <div class="price d-flex justify-content-between p-2">
                <div>U.S. Price: <span>{{ $comics[$index]['price'] }}</span></div>
                <div>AVAILABLE</div>
            </div>
            <div class="check ps-2 text-light py-2"><p class="m-0">Check Availability <span>▼</span></p></div>
        </div>
        <div class="description pt-2">{{ $comics[$index]['description'] }}</div>
    </div>
    <div class="adv-box">
    ...
    <div class="container d-flex gap-5">
        ...
        <div class="specs">
            ...
            <div class="d-flex">
                ...
                <p class="w-75 m-0"><a href="#">{{ strtoupper($comics[$index]['series']) }}</a></p>
            </div>
            <hr>
            <div class="d-flex">
                <p class="fw-bold w-25 m-0">U.S. Price:</p>
                <p class="w-75 m-0">{{ $comics[$index]['price'] }}</p>
            </div>
            <hr>
            <div class="d-flex">
                <p class="fw-bold w-25 m-0">On Sale Date:</p>
                <p class="w-75 m-0">{{ $comics[$index]['sale_date'] }}</p>
            </div>
            <hr>
        </div>
    </div>
